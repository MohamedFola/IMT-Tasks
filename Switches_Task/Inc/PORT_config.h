...
#define GPIOA_PIN4_MODE 		              Input_Mode
#define GPIOA_PIN5_MODE 		              Input_Mode
#define GPIOA_PIN6_MODE 		              Input_Mode
#define GPIOA_PIN7_MODE 		              Input_Mode
#define GPIOA_PIN8_MODE 		              Input_Mode
#define GPIOA_PIN9_MODE 		              Input_Mode
#define GPIOA_PIN10_MODE 		              Input_Mode
#define GPIOA_PIN11_MODE 		              Input_Mode
#define GPIOA_PIN12_MODE 		              Input_Mode
#define GPIOA_PIN15_MODE 		              Input_Mode

#define GPIOB_PIN0_MODE 		              Input_Mode
#define GPIOB_PIN1_MODE                       Input_Mode
#define GPIOB_PIN2_MODE                       Input_Mode
...
#define GPIOB_PIN8_MODE                       Input_Mode
#define GPIOB_PIN9_MODE                       Input_Mode
#define GPIOB_PIN10_MODE                      Input_Mode
#define GPIOB_PIN11_MODE                      Input_Mode
#define GPIOB_PIN12_MODE                      Input_Mode
#define GPIOB_PIN13_MODE                      Input_Mode
#define GPIOB_PIN14_MODE		              Input_Mode
#define GPIOB_PIN15_MODE                      Input_Mode

#define GPIOC_PIN13_MODE                      Input_Mode
...
#define GPIOB_PIN2_PU_PD                      Pull_Down
...
/*
	...
	NOTE --> you can control the locking of pins only when choosing Active_Lock at previous configuration
*/
...
#define GPIOB_PIN11_Lock                      Not_Locked
